            ...
            <div class="card">
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="akreditas" value="<?= set_value('akreditas')?>" class="form-control" id="akreditas" placeholder="Akreditas">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="output_lulusan" value="<?= set_value('output_lulusan')?>" class="form-control" id="output_lulusan" placeholder="Lulusan">
