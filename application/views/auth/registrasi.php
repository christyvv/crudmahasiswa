                                ...
                                <div class="card-body">
                                    <form class="user" method="POST" action="<?= base_url('auth/registrasi'); ?>">
                                        ...
                                        <div class="form-floating mb-3">
                                            <input class="form-control" name="nama" value="<?= set_value('nama'); ?>"
                                                id="nama" type="text" placeholder="Enter your full name" />
                                        ...
                                        <div class="form-floating mb-3">
                                            <input class="form-control" value="<?= set_value('email'); ?>" name="email"
                                    ...
                                    <div class=" card-footer text-center py-3">
                                                    <div class="small"><a href="<?= base_url('Auth'); ?>">Have an
